...
var Timeline = /*#__PURE__*/function (_TimelineEventsEmitte) {
  ...
  function Timeline() {
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_trackedObjects", []);
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_leftMargin", function () {
      var _this$_options5;
      return ((_this$_options5 = _this._options) === null || _this$_options5 === void 0 ? void 0 : _this$_options5.leftMargin) || 0;
    });
      ...
      try {
        ...
        viewModel.rowsViewModels.forEach(function (rowViewModel) {
          ...
          if (bounds !== null && bounds !== void 0 && bounds.rect) {
            ...
            _this._trackedObjects.push(_objectSpread(_objectSpread({}, rect), {}, {
              id: rowViewModel.id
            }));
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_renderTimelineCap", function (timeLinePos, y) {
      var _this$_options6, _this$_options6$timel;
      var capStyle = (_this$_options6 = _this._options) === null || _this$_options6 === void 0 ? void 0 : (_this$_options6$timel = _this$_options6.timelineStyle) === null || _this$_options6$timel === void 0 ? void 0 : _this$_options6$timel.capStyle;
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_filterDraggableElements", function (elements) {
      ...
      var filteredElements = elements.filter(function (element) {
        ...
        if (element.type === TimelineElementType.Keyframe) {
          ...
          var _this$_options7;
          if (((_this$_options7 = _this._options) === null || _this$_options7 === void 0 ? void 0 : _this$_options7.timelineDraggable) === false) {
            return false;
          }
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "elementFromPoint", function (pos, clickRadius, onlyTypes) {
      ...
      var width = 0;
      var timelineStyle = (_this$_options8 = _this._options) === null || _this$_options8 === void 0 ? void 0 : _this$_options8.timelineStyle;
      if (timelineStyle) {
